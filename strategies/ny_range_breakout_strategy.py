...
class NYRangeBreakout(TradingStrategy):
    ...
    def __init__(
        ...
        use_trailing_stop: bool = True,  # Activar trailing stop
        trailing_stop_pips: float = 20.0,  # Trailing stop en pips
        trailing_activation_pips: float = 30.0,  # Pips de ganancia para activar trailing
        **kwargs
    ):
        """
        ...
        Args:
            ...
            use_trailing_stop: Si True, activa trailing stop dinámico
            trailing_stop_pips: Distancia del trailing stop en pips (20)
            trailing_activation_pips: Pips de ganancia para activar trailing (30)
        """
        parameters = {
        ...
        super().__init__(
            ...
            use_trailing_stop=use_trailing_stop,
            trailing_stop_pct=trailing_stop_pips * pip_value / 100,  # Convertir a porcentaje
            **kwargs
        )
        ...
        if use_trailing_stop:
            logger.info(f"Trailing Stop: {trailing_stop_pips} pips (activación: {trailing_activation_pips} pips)")
        else:
            logger.info("Trailing Stop: Desactivado")
    ...
    def get_parameter_ranges(self) -> Dict[str, Tuple]:
        ...
        return {
            ...
            'trailing_stop_pips': (10, 30, 2),  # Optimizar trailing stop
            'trailing_activation_pips': (15, 50, 5),  # Optimizar activación
        }
